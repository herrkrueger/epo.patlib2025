"""
USGS Market Data Collector - Code Example Template
...
class USGSMarketDataCollector:
    ...
    def get_market_events_timeline(self) -> List[Dict]:
        ...
        return [
            {
                'year': 2011,
                'event': 'China Export Quota Crisis',
                'description': '700% neodymium price increase due to Chinese export restrictions',
                'impact_type': 'supply_shock'
            },
            {
                'year': 2020,
                'event': 'COVID-19 Supply Disruption',
                'description': 'Global supply chain disruptions affecting REE trade',
                'impact_type': 'logistics_shock'
            },
            {
                'year': 2022,
                'event': 'Ukraine Conflict Effects',
                'description': 'Geopolitical tensions affecting critical materials supply',
                'impact_type': 'geopolitical_shock'
            }
        ]
